          ...
          {executives.map((executive, index) => (
            <Card key={index} className="bg-white border-none shadow-md hover:shadow-xl transition-shadow overflow-hidden">
              ...
              <CardContent className="pt-6 pb-6">
                ...
                <p className="text-biotech-600 font-medium mb-2">{executive.title}</p>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-md p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <a href="#" className="text-biotech-600 hover:text-biotech-800 font-medium text-sm inline-flex items-center">
                View Open Positions
